...
Write-Host @"
╔════════════════════════════════════════════╗
║          P1AE Mod Analyzer v1.3            ║
║       Minecraft Mod Cheat Detector         ║
╚════════════════════════════════════════════╝
"@ -ForegroundColor Magenta

$HtmlUrl = "https://raw.githubusercontent.com/p1ae/powershell/main/index.html"
...
try {
    ...
    Write-Host ""
    Write-Host "The P1AE Mod Analyzer is now open." -ForegroundColor Green
    Write-Host "You can drag & drop .jar/.zip files or use the folder scanner." -ForegroundColor Gray
    ...
    Write-Host "https://raw.githubusercontent.com/p1ae/powershell/main/index.html" -ForegroundColor White
    Write-Host ""
